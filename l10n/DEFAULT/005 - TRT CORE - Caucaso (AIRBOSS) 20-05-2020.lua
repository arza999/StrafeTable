...
local tanker=RECOVERYTANKER:New(UNIT:FindByName("☮ CVN-74 Stennis"), "☮ YPF")  
:SetTakeoffAir()
...
local tanker2=RECOVERYTANKER:New(UNIT:FindByName("☮ CVN-74 Stennis"), "☮ ARCO")  
:SetTakeoffAir()
...
local awacs=RECOVERYTANKER:New(UNIT:FindByName("☮ CVN-74 Stennis"), "☮ Wizard") 
:SetAWACS()
:SetTakeoffAir()
:SetRadio(251)
:SetAltitude(20000)
:SetHomeBase("☮ CVN-74 Stennis")
...
local rescuehelo=RESCUEHELO:New(UNIT:FindByName("☮ CVN-74 Stennis"), "☮ Rescate")  

...
ctld.maximumDistanceLogistic = 900 -- max distance from vehicle to logistics to allow a loading or spawning operation
...
ctld.numberOfTroops = 24 -- default number of troops to load on a transport heli or C-130 
...
ctld.vehiclesForTransportBLUE = { "M1045 HMMWV TOW", "M1043 HMMWV Armament", "M-1 Abrams", "Vulcan" } -- vehicles to load onto c130 - Alternatives {"M1128 Stryker MGS","M1097 Avenger"}

ctld.aaLaunchers = 1 -- controls how many launchers to add to the kub/buk when its spawned.
...
ctld.AASystemLimitRED = 2000 -- Red side limit

ctld.AASystemLimitBLUE = 2000 -- Blue side limit
...
ctld.pickupZones = {
    { "ROME AND VETKA FARPS", "white", -1, "yes", 0 },
    { "FARP MADRID", "orange", -1, "yes", 0 },
    { "FARP DUBLIN", "orange", -1, "yes", 0 },
    { "FARP WARSAW", "orange", -1, "yes", 0 },
    { "FARP BERLIN", "orange", -1, "yes", 0 },
    { "FARP DALLAS", "orange", -1, "yes", 0 },
    ...
    { "☮ CVN-74 Stennis", "blue", -1, "yes", 0 }, -- instead of a Zone Name you can also use the UNIT NAME of a ship
    { "☮ LHA-1 Tarawa", "blue", -1, "yes", 0 }, -- instead of a Zone Name you can also use the UNIT NAME of a ship
}
...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
        ...
        { weight = 501, desc = "HMMWV MG", unit = "M1043 HMMWV Armament", side = 2 },
	
	    { weight = 502, desc = "M-1 Abrams", unit = "M-1 Abrams", side = 2,  cratesRequired = 4 },
	    { weight = 503, desc = "M-2 Bradley", unit = "M-2 Bradley", side = 2, cratesRequired = 3   },
        { weight = 504, desc = "Vulcan", unit = "Vulcan", side = 2, cratesRequired = 3  },
	
        { weight = 505, desc = "BTR-D", unit = "BTR_D", side = 1 },
        { weight = 506, desc = "BRDM-2", unit = "BRDM-2", side = 1 },

        { weight = 507, desc = "HMMWV - JTAC", unit = "Hummer", side = 2, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
        { weight = 508, desc = "SKP-11 - JTAC", unit = "SKP-11", side = 1, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
        ...
        if _heli ~= nil and ctld.inAir(_heli) == false then
            ...
            elseif _crate ~= nil and _crate.dist < 200 then
                ...
                if ctld.inLogisticsZone(_heli) == true then
                    ...
                    ctld.displayMessageToGroup(_heli, "You can't unpack crates close to pickup/logistic zones! Take it to where it's needed!", 20)
